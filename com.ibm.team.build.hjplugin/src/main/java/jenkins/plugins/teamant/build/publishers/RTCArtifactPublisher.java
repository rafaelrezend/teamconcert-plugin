 ...
 *
 */
public class RTCArtifactPublisher extends Recorder implements SimpleBuildStep {
	...
	public RTCArtifactPublisher(String label, String logFile) {
		this.label = label;
	...
	public static final class DescriptorImpl extends
		...
		public String getDisplayName() {
			return "Publish artifact to RTC Build Result";
		}
	}
